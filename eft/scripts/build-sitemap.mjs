...
const maps = JSON.parse(readFileSync(path.join(__dirname, '..', 'src', 'data', 'maps.json'), 'utf8'));
const categoryPages = JSON.parse(readFileSync(path.join(__dirname, '..', 'src', 'data', 'category-pages.json'), 'utf8'));
