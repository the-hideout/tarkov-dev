const alertConfig = {
    ...
    text: '🌟 We don\'t currently have flea market scanners leveled for PVP prices and don\'t know when PVP flea market prices will be available. PVE flea prices remain available.',
    ...
    bannerKey: 'alertBanner-0.16.9-pvp',
}
