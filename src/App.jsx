...
const StreamElements = React.lazy(
  () => import("./pages/stream-elements/index.jsx"),
);
...
const BarterItems = React.lazy(
  () => import("./pages/items/barter-items/index.jsx"),
);
const Containers = React.lazy(
  () => import("./pages/items/containers/index.jsx"),
);
...
const PistolGrips = React.lazy(
  () => import("./pages/items/pistol-grips/index.jsx"),
);
const Provisions = React.lazy(
  () => import("./pages/items/provisions/index.jsx"),
);
const Rigs = React.lazy(() => import("./pages/items/rigs/index.jsx"));
const Suppressors = React.lazy(
  () => import("./pages/items/suppressors/index.jsx"),
);
const BsgCategory = React.lazy(
  () => import("./pages/items/bsg-category/index.jsx"),
);
const HandbookCategory = React.lazy(
  () => import("./pages/items/handbook-category/index.jsx"),
);
const BitcoinFarmCalculator = React.lazy(
  () => import("./pages/bitcoin-farm-calculator/index.jsx"),
);
...
const PlayerForward = React.lazy(
  () => import("./pages/player/player-forward.jsx"),
);
...
function Fallback({ error, resetErrorBoundary }) {
  ...
  if (
    ...
    loadingChunkErrorMessage = (
      <div>
        This error is often caused by caching issues and can usually be resolved
        by{" "}
        <button
...
function App() {
  ...
  useEffect(() => {
    ...
    const connect = function connect() {
      socket = new WebSocket(
        socketServer + `?sessionid=${encodeURIComponent(sessionID)}`,
      );
  ...
  const alternateLangs = supportedLanguages.filter(
          ...
          <Routes>
            ...
            <Route
              ...
              element={[
                <Suspense
                  fallback={<Loading />}
                  key="suspense-loot-tier-wrapper"
                >
            ...
            <Route
              ...
              element={[
                <Suspense
                  fallback={<Loading />}
                  key="suspense-backpacks-wrapper"
                >
            ...
            <Route
              ...
              element={[
                <Suspense
                  fallback={<Loading />}
                  key="suspense-suppressors-wrapper"
                >
            ...
            <Route
              ...
              element={[
                <Suspense
                  fallback={<Loading />}
                  key="suspense-containers-wrapper"
                >
            ...
            <Route
              ...
              element={[
                <Suspense
                  fallback={<Loading />}
                  key="suspense-provisions-wrapper"
                >
            ...
            <Route
              ...
              element={[
                <Suspense
                  fallback={<Loading />}
                  key="suspense-api-users-wrapper"
                >
                  <ApiUsers />
                </Suspense>,
                remoteControlSessionElement,
            ...
            <Route
              ...
              element={[
                <Suspense
                  fallback={<Loading />}
                  key="suspense-wipe-length-wrapper"
                >
            ...
            <Route
              ...
              element={[
                <Suspense
                  fallback={<Loading />}
                  key="suspense-errorpage-wrapper"
                >
                  <ErrorPage />
                </Suspense>,
                remoteControlSessionElement,
