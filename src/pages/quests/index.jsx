...
function Quests() {
    ...
    const [hideNonKappa, setHideNonKappa] = useStateWithLocalStorage("hideNonKappaTasks", false);
    const [hideNonLK, setHideNonLK] = useStateWithLocalStorage("hideNonLKTasks", false);
            ...
            <div className="quests-headline-wrapper" key="quests-headline">
                ...
                <Filter>
                    ...
                    <ToggleFilter
                        ...
                        tooltipContent={<>{t("Required for Kappa")}</>}
                    />
                    <ToggleFilter
                        checked={hideNonLK}
                        label={t("Lightkeeper")}
                        onChange={(e) => setHideNonLK(!hideNonLK)}
                        tooltipContent={<>{t("Required for Lightkeeper")}</>}
                    />
                    <ButtonGroupFilter>
                        {traders.map((trader) => {
                            return (
