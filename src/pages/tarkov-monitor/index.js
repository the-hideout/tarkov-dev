    ...
    return [
        ...
        <div className="page-wrapper tool-detail-page tarkov-monitor-page" key="tarkov-monitor-wrapper">
            ...
            <section id="download">
                <h2>{t("Download")}</h2>
                <ol>
                    <li>{t("tarkov-monitor-download-1", "Grab the latest TarkovMonitor.zip release from GitHub.")}</li>
                    <li>{t("tarkov-monitor-download-2", "Extract the archive anywhere on your PC.")}</li>
                    <li>{t("tarkov-monitor-download-3", "Run TarkovMonitor.exe and keep it open while you play.")}</li>
                </ol>
            </section>
