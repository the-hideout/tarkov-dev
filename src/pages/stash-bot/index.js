...
const popularCommands = [
    {
        ...
        description: "The help command to view all available commands",
    },
    {
        command: "/about",
        example: "-",
        description: "View details about the bot",
    },
    {
        command: "/ammo",
        example: "/ammo ammo_type: 5.45x39mm",
        description: "Get a sorted ammo table for a certain ammo type",
    },
    {
        command: "/barter",
        example: "/barter name: <item>",
        description: "Check barter details for an item",
    },
    {
        command: "/boss",
        example: "-",
        description: "Get detailed information about a boss",
    },
    {
        command: "/changes",
        example: "-",
        description: "Get the latest game changes from tarkov-changes.com",
    },
    {
        command: "/craft",
        example: "/craft name: <item>",
        description: "Check crafting details for an item",
    },
    {
        command: "/gamemode",
        example: "-",
        description: "Set the game mode (regular, PVE) for bot responses",
    },
    {
        command: "/goons",
        example: "-",
        description: "Check or report the location of the Goons",
    },
    {
        command: "/invite",
        example: "-",
        description: "Get a Discord invite link for the bot to join it to another server",
    },
    {
        command: "/issue",
        example: "/issue message: <text>",
        description: "Report an issue with the bot",
    },
    {
        command: "/item",
        example: "-",
        description: "Get price, craft, barter, etc. information about an item",
    },
    {
        command: "/key",
        example: "-",
        description: "Get a key's price and maps it is used on",
    },
    {
        command: "/map",
        example: "/map woods",
        description: "View a map and some general info about it",
    },
    {
        command: "/patchnotes",
        example: "-",
        description: "Get the latest official patchnotes for EFT",
    },
    {
        command: "/player",
        example: "-",
    ...
    {
        command: "/price",
        example: "/price name: <item>",
        description: "Get a detailed output on the price of an item, its price tier, and more!",
    },
    {
        command: "/progress",
        example: "-",
        description: "Manage your customized hideout and trader progress",
    },
    {
        command: "/quest",
        example: "-",
        description: "Get detailed information about a quest",
    },
    {
        command: "/restock",
        example: "-",
        description: "Show or set alerts for trader restock timers",
    },
    {
        command: "/roulette",
        example: "-",
        description: "Play a game of roulette to determine how you play your next raid",
    },
    {
        command: "/status",
        example: "-",
        description: "Get the game/server/website status of Escape from Tarkov",
    },
    {
        command: "/stim",
        example: "-",
        description: "Get information about a in-game stim",
    },
    {
        command: "/tier",
        example: "-",
        description: "Show the criteria for loot tiers",
    },
...
function StashBotPage() {
    ...
    return [
        <SEO
            ...
            description={t(
                "stash-page-description",
                "Invite the Stash Discord bot, explore its commands, and see how it can help your community.",
            )}
            key="seo-wrapper"
        />,
        <div className="page-wrapper tool-detail-page stash-page" key="stash-wrapper">
            ...
            <section className="tool-card-grid" aria-label={t("Highlights")}>
                ...
                <article>
                    ...
                    <ul>
                        ...
                        <li>
                            {t(
                                "Progress command mirrors the hideout and trader upgrades you have saved on TarkovTracker.",
                            )}
                        </li>
            ...
            <section id="command-overview">
                ...
                <p>{t("Stash exposes dozens of slash commands. Here are a few that most servers rely on:")}</p>
          ...
          <p>
            ...
            or chat with the developers inside the{" "}
            <a
            ...
            . If you are syncing Tarkov.dev and the bot data, include
            screenshots plus reproduction steps so we can help faster.
          </p>
        </Trans>
                <p>
                    {t(
                        "Need the privacy policy or terms of service for your server security review? They live inside the /assets folder of the repository and stay up-to-date with every release.",
                    )}
                </p>
                <p>
                    {t(
