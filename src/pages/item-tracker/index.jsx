            ...
            .map((questData) => {
                ...
                return (
                    <ItemGrid
                        ...
                        items={questItems}
                        extraTitleProps={
                            <button onClick={handleDoneClick.bind(this, questData.questId)}>{t("Collected")}</button>
                        }
                    />
                );
            });
            ...
            <div className="item-group-wrapper filter-wrapper">
                <div className={"filter-content-wrapper"}>
                    ...
                    <label className={"filter-toggle-wrapper"}>
                        <span className={"filter-toggle-label"}>{t("Only show Found in Raid")}</span>
                        <Switch
                            className={"filter-toggle"}
                    ...
                    <label className={"filter-toggle-wrapper"}>
                        <button onClick={() => setQuestData(quests)}>{t("Reset all tracking")}</button>
                    </label>
                </div>
            </div>
            {displayQuests}
