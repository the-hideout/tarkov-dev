...
function Barters() {
    ...
    const traders = useMemo(() => {
        return allTraders.filter(
            (trader) =>
                trader.normalizedName !== 'fence' && trader.normalizedName !== 'lightkeeper',
        );
    }, [allTraders]);
        ...
        <div className={'page-wrapper'} key="barters-page-wrapper">
            ...
            <div className="page-wrapper barters-page-wrapper">
                <Trans i18nKey={'barters-page-p'}>
                    <p>
                        Except for Fence, every trader in Escape from Tarkov offers goods by barter
                        rather than for purchase outright.
                        <p></p>
                        In exchange for a variety of inexpensive things, the player can frequently
                        trade them for more valuable objects that can be utilized or sold for a
                        profit or higher level gear at lower loyalty levels.
                        <p></p>
                        Be sure to check back after reset for your favorite transactions because the
                        majority of these valued trades have strict limits per trader reset and
                        frequently sell out.
                    </p>
                </Trans>
            </div>
