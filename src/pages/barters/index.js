...
function Barters() {
    ...
    return [
        <Helmet key={'loot-tier-helmet'}>
            ...
            <meta name="description" content={t('This page includes information on the different items that can be traded with NPC vendors, the barter prices, and the profits that can be made from selling the items.')} />
        </Helmet>,
