    ...
    return [
        ...
        <div className={'page-wrapper'} key="about-page-content">
            ...
            <Trans i18nKey={'about-support-ukraine-p'}>
                <p>
                    We encourage everyone who can to donate to support the people of Ukraine using
                    the button below.
                </p>
            </Trans>
            <UkraineButton />
            ...
            <Trans i18nKey={'about-support-more-p'}>
                <p>
                    You can also help by posting bugs, suggesting or implementing new features,
                    improving maps or anything else you can think of that would improve the site.
                </p>
            </Trans>
            <h2>{t('API')}</h2>
            <Trans i18nKey={'about-api-p'}>
                <p>
                    We offer a 100% free and publically accessible API for all your Tarkov
                    development needs - <Link to="/api/">API</Link>.
                </p>
            </Trans>
            <h2>{t('History')}</h2>
            <Trans i18nKey={'about-history-p'}>
                <p>
                    ...
                    . The original creator <a href="https://github.com/kokarn">@kokarn</a> decided
                    to shut the site down. In the spirit of open source, a group of developers came
                    together to revive the site in order to continue providing a great website for
                    the Tarkov community and an API to power further development for creators. This
                    project is now 100% open source and developer first. Our GitHub Organization (
                    <a
                        href="https://github.com/the-hideout"
                        target="_blank"
                        rel="noopener noreferrer"
                    >
                        the-hideout
                    </a>
                    ) contains all the repos which power the API, this website, the community
                    Discord bot, server infrastructure, and much more! We are passionate about open
                    source and love pull requests to improve our ecosystem for all.
                </p>
            </Trans>
            <h2>{t('Core Contributors')}</h2>
            <Trans i18nKey={'about-core-contributors-p'}>
                <p>The core contributors to this project (in no particular order) are:</p>
            </Trans>
            <ul>
                <li>
                    <a
                        href="https://github.com/Razzmatazzz"
                        target="_blank"
                        rel="noopener noreferrer"
                    >
                ...
                <li>
                    <a
                        href="https://github.com/austinhodak"
                        target="_blank"
                        rel="noopener noreferrer"
                    >
                ...
                <li>
                    <a
                        href="https://github.com/Blightbuster"
                        target="_blank"
                        rel="noopener noreferrer"
                    >
                ...
                <li>
                    <a
                        href="https://github.com/johndongus"
                        target="_blank"
                        rel="noopener noreferrer"
                    >
            ...
            <Trans i18nKey={'about-all-contributors-p'}>
                <p>
                    Massive thank you to all the people that have contributed to this project to
                    make it possible! ❤️
                </p>
            </Trans>
