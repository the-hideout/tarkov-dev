        ...
        <div className={'page-wrapper api-docs-page-wrapper'}>
            ...
            <Trans i18nKey={'api-about-p'}>
                <div className="section-text-wrapper">
                    ...
                    To learn about what queries you can make and how the schema is structured, visit the playground and click the book icon in the upper right to read the documentation.
