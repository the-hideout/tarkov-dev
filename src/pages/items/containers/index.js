    ...
    return [
        ...
        <div className="display-wrapper" key={'display-wrapper'}>
            ...
            <div className="page-wrapper items-page-wrapper">
                <p>
                    {t("As their name implies, containers in Escape from Tarkov are items used to hold other things. Some of these items are used to clear up inventory space by acting as storage and taking up less inventory slots however some of them cannot be equipped on the character.")}
                </p>
            </div>
        </div>,
    ];
