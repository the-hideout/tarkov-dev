...
function Grenades() {
    ...
    return [
        <SEO
            ...
            description={t(
                "grenades-page-description",
                "This page includes a sortable table with information on the different types of grenades available in the game, including their price, damage, and other characteristics.",
            )}
            key="seo-wrapper"
        />,
