...
function Nightbot() {
    ...
    return (
        (
            <SEO
                title={`${t('Tarkov.dev {{bot}} integration', { bot: botName })} - ${t(
                    'Tarkov.dev',
                )}`}
                description={t(
            ...
            <div className={'page-wrapper nightbot-page-wrapper'}>
                ...
                <ul>
                    ...
                    <li>
                        {t('Go to dashboard')}{' '}
                        <a
                            href="https://nightbot.tv/dashboard"
                            target="_blank"
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <a
                            href="https://nightbot.tv/commands/custom"
                            target="_blank"
                            rel="noopener noreferrer"
                        >
                ...
                <p>
                    {t('Big thanks to')}{' '}
                    <a
                        href="https://www.twitch.tv/PhreakinPhil"
                        target="_blank"
                        rel="noopener noreferrer"
                    >
                        PhreakinPhil
