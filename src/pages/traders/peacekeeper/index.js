...
function Peacekeeper() {
    ...
    const [selectedTable, setSelectedTable] = useStateWithLocalStorage('peacekeeperSelectedTable', 'level');
    ...
    return [
        ...
        >
            ...
            >
                <h1>
                    Escape from Tarkov Peacekeeper items
                </h1>
                <Filter
                    center
                >
